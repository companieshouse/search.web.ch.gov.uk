...
import {
    checkLineBreakRequired, formatLongDate, formatCompactAddress, changeDateFormat,
    getPagingRange, buildPagingUrl, mapCompanyStatusCheckboxes
} from "../utils/utils";
...
const route = async (req: Request, res: Response) => {
    ...
    if (!errors.isEmpty()) {
        return res.render(templatePaths.ADVANCED_SEARCH_RESULTS, { ...errorList, companyNameIncludes, companyNameExcludes, location, incorporatedFrom, incorporatedTo, selectedStatusCheckboxes });
    };
    ...
    const partialHref: string = buildPagingUrl(companyNameIncludes, companyNameExcludes, location, incorporatedFrom, incorporatedTo, companyStatus);
    return res.render(templatePaths.ADVANCED_SEARCH_RESULTS,
        { searchResults, companyNameIncludes, companyNameExcludes, location, page, numberOfPages, pagingRange, partialHref, incorporatedFrom, incorporatedTo, selectedStatusCheckboxes });
};
